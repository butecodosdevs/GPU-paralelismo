...
polignais convexas ou não convexas, planos cartesianos.
Trigonometria e sua incrivel relação com efeitos procedurais, pseudo-aleatoriedade e animações esqueléticas.
...
como funciona shaders. Em linguagens de programaçãop como C, temos primitivos de inteiros, 
floats, doubles (float 64), mas não temos operadores de álgebra linear especializados.
