...
Draw call é uma operação nas APIs, encarregada de dar um sinal para utilizar as informações atuais liggadas já definidas pela aplicação, essas informações podem ser uma quantidade de buffers, metadados, shaders, texturas, uniforms etc.  
